...
export function SettingsLayout({
  ...
  return (
    <div className={`mx-auto max-w-7xl p-4 md:p-6 ${saveStatus === "unsaved" ? "pb-28 md:pb-32" : ""}`}>
      ...
      {saveStatus === "unsaved" ? (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 px-4 py-3 shadow-[0_-12px_30px_rgba(15,23,42,0.12)] backdrop-blur">
          <div className="mx-auto flex max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm font-medium text-slate-700">You have unsaved settings changes.</p>
